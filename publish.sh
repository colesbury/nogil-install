...
anaconda copy colesbury/mkl_random/1.1.0 --to-owner nogil
...
anaconda copy colesbury/six/1.14.0 --to-owner nogil
anaconda copy colesbury/tbb/2020.0 --to-owner nogil
anaconda copy colesbury/tbb-devel/2020.0 --to-owner nogil
